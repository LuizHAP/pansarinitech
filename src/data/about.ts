...
export const about: About = {
  paragraphs: {
    en: [
      ...
      'Today at Machinery Partner I lead the no-code → Next.js + headless CMS migration powering the first US heavy-machinery e-commerce. Same engineer who used to reset printers, now shipping the platform recruiters in Boston build their day around.',
    ...
    pt: [
      ...
      'Hoje na Machinery Partner lidero a migração de no-code para Next.js + headless CMS que sustenta o primeiro e-commerce de máquinas pesadas dos EUA. Mesmo engenheiro que resetava impressoras, agora entregando a plataforma que pessoas em Boston abrem todo dia.',
