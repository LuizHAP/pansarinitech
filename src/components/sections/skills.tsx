...
//
// Icons are pre-bundled at build time (scripts/extract-skill-icons.mjs → src/data/skill-icons.json)
// to eliminate @iconify/react CDN round-trips. addCollection runs once at module load.
...
// Register all skill icons offline — no CDN fetches during runtime.
// The JSON is generated by `pnpm prebuild` (scripts/extract-skill-icons.mjs).
